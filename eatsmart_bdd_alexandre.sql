...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 27 oct. 2025 à 15:14
...
--
-- Base de données : `eatsmart_bdd_alexandre`
--
CREATE DATABASE IF NOT EXISTS `eatsmart_bdd_alexandre` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
USE `eatsmart_bdd_alexandre`;
...
(99, 'pizza dela mama', 100.0000, 'KDO de dieu', 1);
...
(10, '2024-10-25 00:00:00', 10, 'en cours');
